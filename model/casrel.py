...
class CasRel(nn.Module):
    def __init__(self, config, graph_encoder):
    ...
    def forward(self, data,span_list,term_list,seq_len):
        encoded_text = self.get_encoded_text(data)
        last_hidden_state = self.graph_encoder(encoded_text,span_list,term_list,seq_len)
